...
The [incident-response workflow review](REVIEW-IR.md) records five new open findings against `9e41268`, including on-host credential exposure, arming review consistency, and repair availability.
